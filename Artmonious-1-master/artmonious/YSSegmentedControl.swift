...
//        self.imgSeparator = UIImageView(frame: CGRect(x: frame.size.width/2-1, y: 0, width: 0.5, height: frame.size.height))
//        self.imgSeparator.backgroundColor = UIColor(red: 67/255.0, green: 176/255.0, blue: 227/255.0, alpha: 1)
//        addSubview(self.imgSeparator)
    }
    ...
    private func defaultAppearance () {
        appearance = YSSegmentedControlAppearance(
            ...
            textColor: UIColor(red: 116/255.0, green: 112/255.0, blue: 112/255.0, alpha: 1),
            font: UIFont.systemFontOfSize(15),
            selectedTextColor: UIColor(red: 67/255.0, green: 176/255.0, blue: 227/255.0, alpha: 1),
            selectedFont: UIFont.systemFontOfSize(15),
            bottomLineColor: UIColor(red: 67/255.0, green: 176/255.0, blue: 227/255.0, alpha: 1),
            selectorColor: UIColor(red: 67/255.0, green: 176/255.0, blue: 227/255.0, alpha: 1),
